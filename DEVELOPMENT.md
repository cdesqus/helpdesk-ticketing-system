...
```bash
git remote add encore encore://helpdesk-ticketing-system-6o32
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/helpdesk-ticketing-system-6o32/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/helpdesk-ticketing-system-6o32/settings/integrations/github)
